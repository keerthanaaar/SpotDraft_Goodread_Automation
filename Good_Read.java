...
public class Good_Read {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement s = driver.findElement(By.xpath("//button[@type=\"submit\"]"));s.click();

		//Mark "want to read"
		WebElement clickproduct= driver.findElement(By.xpath("//button[@class=\"wtrToRead\"]"));       
		clickproduct.click(); 
		Thread.sleep(3000);
		WebElement booktitle= driver.findElement(By.xpath("//a[@class=\"bookTitle\"]"));booktitle.click();
		...
		gotoremove.click(); 
		driver.manage().timeouts().implicitlyWait(80, TimeUnit.SECONDS);
		WebElement remove = driver.findElement(By.xpath("/html/body/div[3]/div/div[3]/div[2]/button")); remove.click();		

		//Sign out
      	        WebElement info= driver.findElement(By.xpath("//*[@id=\"Header\"]/div[2]/nav/ul/li[5]/div/button"));info.click();  
